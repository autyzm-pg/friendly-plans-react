...
export const getPlanSubItemRef = (
  studentId: string, planId: string, planItemId: string, planSubItemId: string
...
export const getPlanSubItemsRef = (
  studentId: string, planId: string, planItemId: string
...
export const getPlanItemRef = (
  studentId: string, planId: string, planItemId: string
    ...
    getPlanItemsRef(studentId, planId).doc(planItemId);
